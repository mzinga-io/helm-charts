...
![Version: 0.5.151](https://img.shields.io/badge/Version-0.5.151-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.3.1](https://img.shields.io/badge/AppVersion-0.3.1-informational?style=flat-square)
...
| backoffice.image.tag | string | `"0.11.0"` |  |
...
| api.replicas | int | `1` |  |
| api.image | object | `{"registry":"newesissrl.azurecr.io","repository":"mzinga/payload/gh/api","tag":"0.11.0"}` | Image specification for MZinga api. |
